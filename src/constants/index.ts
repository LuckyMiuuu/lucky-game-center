...
export const GAME_TEST_LIST = [
    ...
    {
      game_id: 23,
      game_short_name: 'LuckyLumberjack',
      game_show_name: 'Lucky Lumberjack',
      game_url: 'https://t.me/myweb3gamebot/LuckyLumberjack',
      game_img: new URL('@/assets/images/game_lumberjack.png', import.meta.url).href,
      groups: 0,
      rounds: 0,
    },
    {
      game_id: 24,
      game_short_name: 'LuckySplit',
      game_show_name: 'Lucky Split',
      game_url: 'https://t.me/myweb3gamebot/LuckySplit',
    ...
    {
      game_id: 26,
      game_short_name: 'LuckyMatch',
      game_show_name: 'Lucky Match',
      game_url: 'https://t.me/myweb3gamebot/LuckyMatch',
      game_img: new URL('@/assets/images/game_match.png', import.meta.url).href,
      groups: 0,
      rounds: 0,
    },
    {
      game_id: 27,
      game_short_name: 'LuckyPinball',
      game_show_name: 'Lucky Pinball',
      game_url: 'https://t.me/myweb3gamebot/LuckyPinball',
      game_img: new URL('@/assets/images/game_pinball.png', import.meta.url).href,
      groups: 0,
      rounds: 0,
    },
    {
      game_id: 28,
      game_short_name: 'LuckyFighter',
      game_show_name: 'Lucky Fighter',
      game_url: 'https://t.me/myweb3gamebot/LuckyFighter',
    ...
    {
      game_id: 30,
      game_short_name: 'LuckyRacer',
      game_show_name: 'Lucky Racer',
      game_url: 'https://t.me/myweb3gamebot/LuckyRacer',
      game_img: new URL('@/assets/images/game_racer.png', import.meta.url).href,
      groups: 0,
      rounds: 0,
    },
]
export const GAME_PROD_LIST = [
    ...
    },
    {
      ...
      game_short_name: 'LuckyLumberjack',
      game_show_name: 'Lucky Lumberjack',
      game_url: 'https://t.me/LuckyMiuuu_bot/LuckyLumberjack',
      game_img: new URL('@/assets/images/game_lumberjack.png', import.meta.url).href,
      groups: 0,
      rounds: 0,
    },
    ...
    },
    {
      ...
      game_short_name: 'LuckyMatch',
      game_show_name: 'Lucky Match',
      game_url: 'https://t.me/LuckyMiuuu_bot/LuckyMatch',
      game_img: new URL('@/assets/images/game_match.png', import.meta.url).href,
      groups: 0,
      rounds: 0,
    },
    {
      ...
      game_short_name: 'LuckyPinball',
      game_show_name: 'Lucky Pinball',
      game_url: 'https://t.me/LuckyMiuuu_bot/LuckyPinball',
      game_img: new URL('@/assets/images/game_pinball.png', import.meta.url).href,
      groups: 0,
      rounds: 0,
    },
    ...
    },
    {
      ...
      game_short_name: 'LuckyRacer',
      game_show_name: 'Lucky Racer',
      game_url: 'https://t.me/LuckyMiuuu_bot/LuckyRacer',
      game_img: new URL('@/assets/images/game_racer.png', import.meta.url).href,
      groups: 0,
      rounds: 0,
    },
